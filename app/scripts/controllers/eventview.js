...
angular.module('eventsAppApp')
    .controller('EventviewCtrl', function($scope, $modal, $routeParams, $log, singleevent, dateFixer) {

        singleevent.events($routeParams.eventId).success(function(data, status, headers) {
            $scope.event = dateFixer.fixDate(data.events)[0];

            console.log($scope.event);
            return $scope.event;
        });

        $scope.download_ics = function() {
            ...
            var filename = $scope.event.title;
        ...
        $scope.reviewEvent = function() {
            //console.log('submit an event review - clicked');
            var eventReviewModal = $modal.open({
                templateUrl: 'views/partials/eventreview.html',
                controller: 'EventreviewCtrl',
                windowClass: 'eventReviewModal',
                resolve: {
                    eventData: function() {
                        return $scope;
                    }
            ...
            eventReviewModal.opened.then(function() {

                var modalElements = document.getElementsByClassName('modal-content');
                console.log(modalElements[0]);
